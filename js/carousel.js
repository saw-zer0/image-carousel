function Carousel(carouselContainer, carouselWidth, transitionTime, holdTime) {
    ...
    this.assignClassName = () => {
        ...
        this.imageList = document.querySelectorAll('.image-wrapper>img');
    ...
    this.moveImage = (nextPos) => {
        ...
        console.log(nextPos, finalPos, noOfFrames, speed);
        let animation = () => {
            if (speed < 0) {
    ...
    this.addDotsEvent = () => {
        this.dotsArr = Array.from(document.getElementsByClassName('dots'));
        this.dotsArr.forEach((elem, index) => {
